...
@XmlRootElement(name = "queryIdsSingle")
public class QueryIdsSingle {
    ...
    @XmlElementRef(name = "string3", namespace = "http://sharing.mdm07.itf.yonyou.com/IMdSharingCenterService", type = JAXBElement.class)
    ...
    public void setString3(JAXBElement<String> value) {
        this.string3 = ((JAXBElement<String> ) value);
    }

...
@RestController
@RequestMapping(value = "/NytBus") 
public class NytBusController extends BaseController implements ServletContextAware{

	@Autowired
	private NytBusService service;
    ...
    public @ResponseBody Object page(PageRequest pageRequest, SearchParams searchParams) {
        ...
        result.put("nytbusIneqNameData",service.selectIneqNameByPage(pageRequest, searchParams));
        result.put("nytbusIneqNameTime",service.getSyncTime(RedisCacheKey.NYTBUS_INEQNAME_TIME));
        result.put("nytbusOnlyData",service.selectOnlyValidateByPage(pageRequestOnly,searchParams));
        result.put("nytbusOnlyTime",service.getSyncTime(RedisCacheKey.NYTBUS_ONLY_TIME));
    ...
    public void exportExcel(HttpServletResponse response) {
        ...
        try {
            ...
            // 设置这个内容，表示下载这个文件
            response.addHeader("Content-Disposition", "attachment; filename =" + URLEncoder.encode("南粤通车辆数据质量报告.xlsx", "UTF-8"));

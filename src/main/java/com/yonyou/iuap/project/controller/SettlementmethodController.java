...
public class SettlementmethodController extends BaseController implements ServletContextAware {

    @Autowired
    private SettlementmethodService service;
    ...
    Object page(PageRequest pageRequest, SearchParams searchParams) {
        ...
        result.put("stationRequiredTime", service.getSyncTime(RedisCacheKey.SETTLEMENTMETHOD_REQUIRED_TIME));
    ...
    public @ResponseBody
    Object save(@RequestBody List<Settlementmethod> list) {
        service.save(list);
        return buildSuccess();
    }
    ...
    public @ResponseBody
    Object del(@RequestBody List<Settlementmethod> list) {
    ...
    public void exportExcel(HttpServletResponse response) {
        ...
        try {
            ...
            response.addHeader("Content-Disposition", "attachment; filename =" + URLEncoder.encode("结算方式数据质量报告.xlsx", "UTF-8"));

...
@RestController
@RequestMapping(value = "/NytLine") 
public class NytLineController extends BaseController implements ServletContextAware{

	@Autowired
	private NytLineService service;
    ...
    public @ResponseBody Object page(PageRequest pageRequest, SearchParams searchParams) {
        ...
        result.put("nytlineIneqNameData",service.selectIneqNameByPage(pageRequest, searchParams));
        result.put("nytlineIneqNameTime",service.getSyncTime(RedisCacheKey.NYTLINE_INEQNAME_TIME));
        result.put("nytlineOnlyData",service.selectOnlyValidateByPage(pageRequestOnly,searchParams));
        result.put("nytlineOnlyTime",service.getSyncTime(RedisCacheKey.NYTLINE_ONLY_TIME));
        //result.put("zhkylineIneqNameData",service.selectIneqNameByPage(pageRequestRequired, searchParams));

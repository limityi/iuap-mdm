...
public class MerchantsController extends BaseController implements ServletContextAware {
    ...
    Object page(PageRequest pageRequest, SearchParams searchParams) {
        ...
        result.put("stationCompareTime", service.getSyncTime(RedisCacheKey.MERCHANTS_COMPARE_TIME));

        result.put("stationOnlyData", service.selectOnlyValidateByPage(pageRequestOnly, searchParams));
        result.put("stationOnlyTime", service.getSyncTime(RedisCacheKey.MERCHANTS_ONLY_TIME));

        result.put("stationRequiredData", service.selectRequiredData(pageRequestRequired, requiredColumn, searchParams));
        result.put("stationRequiredTime", service.getSyncTime(RedisCacheKey.MERCHANTS_REQUIRED_TIME));
    ...
    public @ResponseBody
    Object save(@RequestBody List<Merchants> list) {
        service.save(list);
        return buildSuccess();
    }
    ...
    public @ResponseBody
    Object del(@RequestBody List<Merchants> list) {

...
@RestController
@RequestMapping(value = "/NytStation") 
public class NytStationController extends BaseController implements ServletContextAware{

	@Autowired
	private NytStationService service;
    ...
    public @ResponseBody Object page(PageRequest pageRequest, SearchParams searchParams) {
        ...
        result.put("nytstationIneqNameData",service.selectIneqNameByPage(pageRequest, searchParams));
        result.put("nytstationIneqNameTime",service.getSyncTime(RedisCacheKey.NYTSTATION_INEQNAME_TIME));
        result.put("nytstationOnlyData",service.selectOnlyValidateByPage(pageRequestOnly,searchParams));
        result.put("nytstationOnlyTime",service.getSyncTime(RedisCacheKey.NYTSTATION_ONLY_TIME));

...
@RestController
@RequestMapping(value = "/ZhkyStation")
public class ZhkyStationController extends BaseController implements ServletContextAware{

	@Autowired
	private ZhkyStationService service;
    ...
    public @ResponseBody Object page(PageRequest pageRequest, SearchParams searchParams) {
        ...
        result.put("zhkystationIneqNameData",service.selectIneqNameByPage(pageRequest, searchParams));
        result.put("zhkystationIneqNameTime",service.getSyncTime(RedisCacheKey.ZHKYSTATION_INEQNAME_TIME));
        result.put("zhkystationOnlyData",service.selectOnlyValidateByPage(pageRequestOnly,searchParams));
        result.put("zhkystationOnlyTime",service.getSyncTime(RedisCacheKey.ZHKYSTATION_ONLY_TIME));

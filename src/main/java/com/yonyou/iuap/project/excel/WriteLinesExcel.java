    ...
    public String createExcelXlsx(Map<String,List<String>> linesMap, String path){
        ...
        for(int i = 0; i < 41; i++){
            ...
            switch(i){
                ...
                case 4 : setRowHeadValue(cell,"描述");setRowHeadValue(cellOnly,cellRequired,"线路简称");break;
                case 5 : setRowHeadValue(cell,"线路简称");setRowHeadValue(cellOnly,cellRequired,"起点地");break;
                case 6 : setRowHeadValue(cell,"起点地");setRowHeadValue(cellOnly,cellRequired,"始发站");break;
                case 7 : setRowHeadValue(cell,"始发站");setRowHeadValue(cellOnly,cellRequired,"终点地");break;
                case 8: setRowHeadValue(cell,"终点地");setRowHeadValue(cellOnly,cellRequired,"终点站");break;
                case 9: setRowHeadValue(cell,"终点站");setRowHeadValue(cellOnly,cellRequired,"途径站点");break;
                case 10 :setRowHeadValue(cell,"途径站点");setRowHeadValue(cellOnly,cellRequired,"途径路线");break;
                case 11 :setRowHeadValue(cell,"途径路线");setRowHeadValue(cellOnly,cellRequired,"起点地配客站");break;
                case 12 :setRowHeadValue(cell,"起点地配客站");setRowHeadValue(cellOnly,cellRequired,"终点地配客站");break;
                case 13 :setRowHeadValue(cell,"终点地配客站");setRowHeadValue(cellOnly,cellRequired,"中途休息点");break;
                case 14 :setRowHeadValue(cell,"中途休息点");setRowHeadValue(cellOnly,cellRequired,"单程时间");break;
                case 15 :setRowHeadValue(cell,"单程时间");setRowHeadValue(cellOnly,cellRequired,"单程里程");break;
                case 16 :setRowHeadValue(cell,"单程里程");setRowHeadValue(cellOnly,cellRequired,"高速里程");break;
                case 17 :setRowHeadValue(cell,"高速里程");setRowHeadValue(cellOnly,cellRequired,"路况等级");break;
                case 18 :setRowHeadValue(cell,"路况等级");setRowHeadValue(cellOnly,cellRequired,"经营类别");break;
                case 19 :setRowHeadValue(cell,"经营类型");setRowHeadValue(cellOnly,cellRequired,"班车类别");break;
                case 20 :setRowHeadValue(cell,"班车类别");setRowHeadValue(cellOnly,cellRequired,"经营性质");break;
                case 21 :setRowHeadValue(cell,"经营性质");setRowHeadValue(cellOnly,cellRequired,"经营范围");break;
                case 22 :setRowHeadValue(cell,"经营范围");setRowHeadValue(cellOnly,cellRequired,"是否粤运所有");break;
                case 23 :setRowHeadValue(cell,"是否粤运所有");setRowHeadValue(cellOnly,cellRequired,"线路所属组织机构");break;
                case 24 :setRowHeadValue(cell,"线路所属组织机构");setRowHeadValue(cellOnly,cellRequired,"投入车辆");break;
                case 25 :setRowHeadValue(cell,"投入车辆");setRowHeadValue(cellOnly,cellRequired,"日发班次");break;
                case 26 :setRowHeadValue(cell,"日发班次");setRowHeadValue(cellOnly,cellRequired,"日均班次");break;
                ...
                case 29 :setRowHeadValue(cell,"日均客流量");setRowHeadValue(cellOnly,cellRequired,"竞争方式");break;
                case 30 :setRowHeadValue(cell,"竞争方式");setRowHeadValue(cellOnly,cellRequired,"竞争车辆");break;
                case 31 :setRowHeadValue(cell,"竞争车辆");setRowHeadValue(cellOnly,cellRequired,"实载率");break;
                case 32 :setRowHeadValue(cell,"实载率");setRowHeadValue(cellOnly,cellRequired,"早班时间");break;
                case 33 :setRowHeadValue(cell,"早班时间");setRowHeadValue(cellOnly,cellRequired,"晚班时间");break;
                case 34 :setRowHeadValue(cell,"晚班时间");setRowHeadValue(cellOnly,cellRequired,"创建时间");break;
                case 35 :setRowHeadValue(cell,"创建时间");setRowHeadValue(cellOnly,cellRequired,"修改时间");break;
                case 36 :setRowHeadValue(cell,"修改时间");setRowHeadValue(cellOnly,cellRequired,"创建人");break;
                case 37 :setRowHeadValue(cell,"创建人");setRowHeadValue(cellOnly,cellRequired,"智慧客运编码");break;
    ...
    private void setRowContent(XSSFSheet sheet, int rowIndex, List<String> data){
        if(!data.isEmpty()&&data.size()>0){
            for (int i=0;i<data.size();i++){
                ...
                this.setRowValue(row,3,lines.getMdm_code());                
                this.setRowValue(row,4,lines.getDescription());
                this.setRowValue(row,5,lines.getLine_shortname());
                this.setRowValue(row,6,lines.getLine_startdistrict());
                this.setRowValue(row,7,lines.getLine_start());
                this.setRowValue(row,8,lines.getLine_endistrict());
                this.setRowValue(row,9,lines.getLine_end());
                this.setRowValue(row,10,lines.getLine_stopby());
                this.setRowValue(row,11,lines.getLine_road());
                this.setRowValue(row,12,lines.getLine_startstop());
                this.setRowValue(row,13,lines.getLine_endstop());
                this.setRowValue(row,14,lines.getLine_midwaystop());
                this.setRowValue(row,15,lines.getLine_lasttime());
                this.setRowValue(row,16,lines.getLine_distance());
                this.setRowValue(row,17,lines.getLine_highwaykm());
                this.setRowValue(row,18,lines.getLine_roadlevel());
                this.setRowValue(row,19,lines.getLine_businesstype());
                this.setRowValue(row,20,lines.getLine_level());
                this.setRowValue(row,21,lines.getLine_businessnature());
                this.setRowValue(row,22,lines.getLine_area());
                this.setRowValue(row,23,lines.getLine_yueyun());
                this.setRowValue(row,24,lines.getLine_institutionname());
                this.setRowValue(row,25,lines.getLine_amount());
                this.setRowValue(row,26,lines.getLine_daybus());
                this.setRowValue(row,27,lines.getLine_avgday_bus());
                this.setRowValue(row,28,lines.getLine_avgday_income());
                this.setRowValue(row,29,lines.getLine_avgday_cust());
                ...
                this.setRowValue(row,40,lines.getRc_code());
    ...
    private void setOnlyRowContent(XSSFSheet sheet, int rowIndex, List<String> data){
        if(!data.isEmpty()&&data.size()>0){
            for (int i=0;i<data.size();i++){
                ...
                this.setRowValue(row,2,lines.getMdm_code());                
                this.setRowValue(row,3,lines.getDescription());
                ...
                this.setRowValue(row,39,lines.getRc_code());

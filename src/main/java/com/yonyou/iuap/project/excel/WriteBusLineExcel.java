    ...
    public String createExcelXlsx(Map<String,List<String>> buslineMap, String path){
        ...
        for(int i = 0; i < 27; i++){
            ...
            switch(i){
                ...
                case 5 : setRowHeadValue(cell,"终点地");setRowHeadValue(cellOnly,cellRequired,"途径站点");break;
                case 6 : setRowHeadValue(cell,"途径站点");setRowHeadValue(cellOnly,cellRequired,"单程时间");break;             
                case 7 :setRowHeadValue(cell,"单程时间");setRowHeadValue(cellOnly,cellRequired,"单程里程");break;               
                case 8 :setRowHeadValue(cell,"单程里程");setRowHeadValue(cellOnly,cellRequired,"经营类型");break;
                case 9 :setRowHeadValue(cell,"经营类型");setRowHeadValue(cellOnly,cellRequired,"经营性质");break;
                case 10 :setRowHeadValue(cell,"经营性质");setRowHeadValue(cellOnly,cellRequired,"线路类型");break;
                case 11 :setRowHeadValue(cell,"线路类型");setRowHeadValue(cellOnly,cellRequired,"线路所属组织机构编码");break;
                case 12 :setRowHeadValue(cell,"线路所属组织机构编码");setRowHeadValue(cellOnly,cellRequired,"投入车辆");break;                
                case 13 :setRowHeadValue(cell,"投入车辆");setRowHeadValue(cellOnly,cellRequired,"日发班次");break;
                case 14 :setRowHeadValue(cell,"日发班次");setRowHeadValue(cellOnly,cellRequired,"日均班次");break;
                case 15 :setRowHeadValue(cell,"日均班次");setRowHeadValue(cellOnly,cellRequired,"日均营收");break;               
                case 16 :setRowHeadValue(cell,"日均营收");setRowHeadValue(cellOnly,cellRequired,"日均客流量");break;
                case 17 :setRowHeadValue(cell,"日均客流量");setRowHeadValue(cellOnly,cellRequired,"竞争方式");break;
                case 18 :setRowHeadValue(cell,"竞争方式");setRowHeadValue(cellOnly,cellRequired,"竞争车辆");break;
                case 19 :setRowHeadValue(cell,"竞争车辆");setRowHeadValue(cellOnly,cellRequired,"实载率");break;
                case 20 :setRowHeadValue(cell,"实载率");setRowHeadValue(cellOnly,cellRequired,"早班时间");break;
                case 21 :setRowHeadValue(cell,"早班时间");setRowHeadValue(cellOnly,cellRequired,"晚班时间");break;
                case 22 :setRowHeadValue(cell,"晚班时间");setRowHeadValue(cellOnly,cellRequired,"备注");break;
                case 23 :setRowHeadValue(cell,"备注");setRowHeadValue(cellOnly,cellRequired,"创建时间");break;
                case 24 :setRowHeadValue(cell,"创建时间");setRowHeadValue(cellOnly,cellRequired,"修改时间");break;
                case 25 :setRowHeadValue(cell,"修改时间");setRowHeadValue(cellOnly,cellRequired,"创建人");break;

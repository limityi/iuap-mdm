...
public class WriteNytStationExcel {
    ...
    public String createExcelXlsx(Map<String,List<String>> zhkystationMap, String path){
        ...
        for(int i = 0; i < 5; i++){
            ...
            if(i == 0){
                cell.setCellValue("南粤通站场 名称比较结果");
            }
        }
        for(int i = 0; i < 4; i++){
        ...
        for(int i = 0; i < 5; i++){
            ...
            switch(i){
                ...
                case 1 : setRowHeadValue(cell,"南粤通站场编码");break;
                case 2 : setRowHeadValue(cell,"南粤通站场名称");break;        
                case 3 : setRowHeadValue(cell,"站场名称");break;
                case 4 : setRowHeadValue(cell,"站场经营单位");break;
                default :break;
            }
        }
    ...
    private void setRowContent(XSSFSheet sheet, int rowIndex, List<String> data){
        if(!data.isEmpty()&&data.size()>0){
            for (int i=0;i<data.size();i++){
                ...
                this.setRowValue(row,0,nytstation.getMcode());
                this.setRowValue(row,1,nytstation.getCode());
                this.setRowValue(row,2,nytstation.getName());
                this.setRowValue(row,3,nytstation.getName1());
                this.setRowValue(row,4,nytstation.getStation_companyname());

...
public class StationService {
    ...
    private void similarityMatch(Page<Station> pageResult) {
        ...
        long resultCacheSize = redisTemplate.llen(RedisCacheKey.STASION_COMPARE_DATA);
        overviewService.updateMdmDataStatistics(DTEnum.MdmSys.MDM.getId(),DTEnum.UserMenus.station.getId().split("md_")[1].toUpperCase(), DTEnum.UserMenus.station.getDtName(), 2, resultCacheSize);

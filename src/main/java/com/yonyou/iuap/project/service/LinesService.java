...
public class LinesService {
    ...
    private void similarityMatch(Page<Lines> pageResult) {
        ...
        long resultCacheSize = redisTemplate.llen(RedisCacheKey.LINE_COMPARE_DATA);
        overviewService.updateMdmDataStatistics(DTEnum.MdmSys.MDM.getId(),DTEnum.UserMenus.lines.getId().split("md_")[1].toUpperCase(), DTEnum.UserMenus.lines.getDtName(), 2, resultCacheSize);

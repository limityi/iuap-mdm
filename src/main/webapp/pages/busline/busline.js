define(['text!pages/busline/busline.html', 'pages/busline/meta','css!pages/busline/busline.css', 'uuitree', 'uuigrid' ],function(html) {
											...
											if (res) {
												if (res.success == 'success') {
													if (res.detailMsg.data) {
														viewModel.totleCount = res.detailMsg.data.buslineCompareData.totalElements;
														viewModel.totlePage = res.detailMsg.data.buslineCompareData.totalPages;
														...
														viewModel.dt1.setSimpleData(
																		res.detailMsg.data.buslineCompareData.content,
																		{
																			unSelect : true
																		});
														viewModel.totleCountOnly=res.detailMsg.data.buslineOnlyData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.buslineOnlyData.totalElements;
														viewModel.totlePageOnly=res.detailMsg.data.buslineOnlyData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.buslineOnlyData.totalPages;
			                                            ...
			                                            viewModel.dtonly.setSimpleData(res.detailMsg.data.buslineOnlyData.content,{unSelect:true});

			                                            viewModel.totleCountRequired=res.detailMsg.data.buslineRequiredData.totalElements;
														viewModel.totlePageRequired=res.detailMsg.data.buslineRequiredData.totalPages;
			                                            ...
			                                            viewModel.dtrequired.setSimpleData(res.detailMsg.data.buslineRequiredData.content,{unSelect:true});
			                                            
														$("#buslineCompareTimeSpan").text(res.detailMsg.data.buslineCompareTime==null?"":res.detailMsg.data.buslineCompareTime);
			                                            $("#buslineOnlyTimeSpan").text(res.detailMsg.data.buslineOnlyTime==null?"":res.detailMsg.data.buslineOnlyTime);
			                                            $("#buslineRequiredTimeSpan").text(res.detailMsg.data.buslineRequiredTime==null?"":res.detailMsg.data.buslineRequiredTime);
													}
												} else {
													var msg = "";
													if (res.success == 'fail_global') {

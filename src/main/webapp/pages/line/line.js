define(['text!pages/line/line.html', 'pages/line/meta','css!pages/line/line.css', 'uuitree', 'uuigrid' ],function(html) {
			var init = function(element) {
				var listUrl = ctx + '/Lines/list?admin=admin';
											...
											if (res) {
												if (res.success == 'success') {
													if (res.detailMsg.data) {
														viewModel.totleCount = res.detailMsg.data.linesCompareData.totalElements;
														viewModel.totlePage = res.detailMsg.data.linesCompareData.totalPages;
														...
														viewModel.dt1.setSimpleData(
																		res.detailMsg.data.linesCompareData.content,
																		{
																			unSelect : true
																		});
														viewModel.totleCountOnly=res.detailMsg.data.linesOnlyData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.linesOnlyData.totalElements;
														viewModel.totlePageOnly=res.detailMsg.data.linesOnlyData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.linesOnlyData.totalPages;
			                                            ...
			                                            viewModel.dtonly.setSimpleData(res.detailMsg.data.linesOnlyData.content,{unSelect:true});

			                                            viewModel.totleCountRequired=res.detailMsg.data.linesRequiredData.totalElements;
														viewModel.totlePageRequired=res.detailMsg.data.linesRequiredData.totalPages;
			                                            ...
			                                            viewModel.dtrequired.setSimpleData(res.detailMsg.data.linesRequiredData.content,{unSelect:true});
			                                            
														$("#linesCompareTimeSpan").text(res.detailMsg.data.linesCompareTime==null?"":res.detailMsg.data.linesCompareTime);
			                                            $("#linesOnlyTimeSpan").text(res.detailMsg.data.linesOnlyTime==null?"":res.detailMsg.data.linesOnlyTime);
			                                            $("#linesRequiredTimeSpan").text(res.detailMsg.data.linesRequiredTime==null?"":res.detailMsg.data.linesRequiredTime);
													}
												} else {
													var msg = "";

define(['text!pages/zhkyline/zhkyline.html', 'pages/zhkyline/meta','css!pages/zhkyline/zhkyline.css', 'uuitree', 'uuigrid' ],function(html) {
			var init = function(element) {
				var listUrl = ctx + '/ZhkyLine/list';
				var delUrl = ctx + '/ZhkyLine/del/';
				var saveUrl = ctx + '/ZhkyLine/save';
				var exportExcelUrl = ctx + '/ZhkyLine/exportExcel'
				...
				var viewModel = {
					...
					zhkylineIneqNameSyncTime : '',
					zhkylineOnlySynTime : '',
					//zhkylineRequiredSyncTime : '',
											...
											if (res) {
												if (res.success == 'success') {
													if (res.detailMsg.data) {
														viewModel.totleCount = res.detailMsg.data.zhkylineIneqNameData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.zhkylineIneqNameData.totalElements;
														viewModel.totlePage = res.detailMsg.data.zhkylineIneqNameData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.zhkylineIneqNameData.totalPages;
														...
														viewModel.dt1.setSimpleData(
																		res.detailMsg.data.zhkylineIneqNameData.content,
																		{
																			unSelect : true
																		});
														
														viewModel.totleCountOnly=res.detailMsg.data.zhkylineOnlyData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.zhkylineOnlyData.totalElements;
														viewModel.totlePageOnly=res.detailMsg.data.zhkylineOnlyData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.zhkylineOnlyData.totalPages;
			                                            ...
			                                            viewModel.dtonly.setSimpleData(res.detailMsg.data.zhkylineOnlyData.content,{unSelect:true});

			                                            /*viewModel.totleCountRequired=res.detailMsg.data.zhkylineIneqNameData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.zhkylineIneqNameData.totalElements;
														viewModel.totlePageRequired=res.detailMsg.data.zhkylineIneqNameData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.zhkylineIneqNameData.totalPages;
			                                            ...
			                                            viewModel.dtrequired.setSimpleData(res.detailMsg.data.zhkylineIneqNameData.content,{unSelect:true});*/
			                                            
														$("#zhkylineIneqNameTimeSpan").text(res.detailMsg.data.zhkylineIneqNameTime==null?"":res.detailMsg.data.zhkylineIneqNameTime);
			                                            $("#zhkylineOnlyTimeSpan").text(res.detailMsg.data.zhkylineOnlyTime==null?"":res.detailMsg.data.zhkylineOnlyTime);
			                                            //$("#zhkylineRequiredTimeSpan").text(res.detailMsg.data.busRequiredTime==null?"":res.detailMsg.data.busRequiredTime);
													}
												} else {
													var msg = "";

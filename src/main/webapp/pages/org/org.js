define(['text!pages/org/org.html', 'pages/org/meta', 'css!pages/org/org.css', 'uuitree', 'uuigrid'], function (html) {
    var init = function (element) {
        ...
        var listUrl = ctx + '/org/list?admin=admin&t=' + timestamp;
        var delUrl = ctx + '/org/del/';
        var saveUrl = ctx + '/org/save';
        var removeDataUrl = ctx + '/org/removeData';
        var exportExcelUrl = ctx + '/org/exportExcel';

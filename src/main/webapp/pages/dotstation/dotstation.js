define(['text!pages/dotstation/dotstation.html', 'pages/dotstation/meta','css!pages/dotstation/dotstation.css', 'uuitree', 'uuigrid' ],function(html) {
			var init = function(element) {
				var listUrl = ctx + '/DotStation/list';
				var delUrl = ctx + '/DotStation/del/';
				var saveUrl = ctx + '/DotStation/save';
				var exportExcelUrl = ctx + '/DotStation/exportExcel'
				...
				var viewModel = {
					...
					dotstationIneqNameSyncTime : '',
					dotstationOnlySynTime : '',
					//dotstationRequiredSyncTime : '',
											...
											if (res) {
												if (res.success == 'success') {
													if (res.detailMsg.data) {
														viewModel.totleCount = res.detailMsg.data.dotstationIneqNameData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.dotstationIneqNameData.totalElements;
														viewModel.totlePage = res.detailMsg.data.dotstationIneqNameData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.dotstationIneqNameData.totalPages;
														...
														viewModel.dt1.setSimpleData(
																		res.detailMsg.data.dotstationIneqNameData.content,
																		{
																			unSelect : true
																		});
			                                            ...
			                                            viewModel.dtrequired.setSimpleData(res.detailMsg.data.dotstationIneqNameData.content,{unSelect:true});*/
			                                            
														$("#dotstationIneqNameTimeSpan").text(res.detailMsg.data.dotstationIneqNameTime==null?"":res.detailMsg.data.dotstationIneqNameTime);
			                                            $("#dotstationOnlyTimeSpan").text(res.detailMsg.data.dotstationOnlyTime==null?"":res.detailMsg.data.dotstationOnlyTime);
			                                            //$("#dotstationRequiredTimeSpan").text(res.detailMsg.data.busRequiredTime==null?"":res.detailMsg.data.busRequiredTime);
													}
												} else {
													var msg = "";

define(['text!pages/zhkybus/zhkybus.html', 'pages/zhkybus/meta','css!pages/zhkybus/zhkybus.css', 'uuitree', 'uuigrid' ],function(html) {
			var init = function(element) {
				var listUrl = ctx + '/ZhkyBus/list';
				var delUrl = ctx + '/ZhkyBus/del/';
				var saveUrl = ctx + '/ZhkyBus/save';
				var exportExcelUrl = ctx + '/ZhkyBus/exportExcel'
				...
				var viewModel = {
					...
					zhkybusIneqNameSyncTime : '',
					zhkybusOnlySynTime : '',
					//zhkybusRequiredSyncTime : '',
											...
											if (res) {
												if (res.success == 'success') {
													if (res.detailMsg.data) {
														viewModel.totleCount = res.detailMsg.data.zhkybusIneqNameData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.zhkybusIneqNameData.totalElements;
														viewModel.totlePage = res.detailMsg.data.zhkybusIneqNameData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.zhkybusIneqNameData.totalPages;
														...
														viewModel.dt1.setSimpleData(
																		res.detailMsg.data.zhkybusIneqNameData.content,
																		{
																			unSelect : true
																		});
														
														viewModel.totleCountOnly=res.detailMsg.data.zhkybusOnlyData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.zhkybusOnlyData.totalElements;
														viewModel.totlePageOnly=res.detailMsg.data.zhkybusOnlyData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.zhkybusOnlyData.totalPages;
			                                            ...
			                                            viewModel.dtonly.setSimpleData(res.detailMsg.data.zhkybusOnlyData.content,{unSelect:true});

			                                            /*viewModel.totleCountRequired=res.detailMsg.data.zhkybusIneqNameData.totalElements==null?viewModel.totleCountOnly:res.detailMsg.data.zhkybusIneqNameData.totalElements;
														viewModel.totlePageRequired=res.detailMsg.data.zhkybusIneqNameData.totalPages==null?viewModel.totlePageOnly:res.detailMsg.data.zhkybusIneqNameData.totalPages;
			                                            ...
			                                            viewModel.dtrequired.setSimpleData(res.detailMsg.data.zhkybusIneqNameData.content,{unSelect:true});*/
			                                            
														$("#zhkybusIneqNameTimeSpan").text(res.detailMsg.data.zhkybusIneqNameTime==null?"":res.detailMsg.data.zhkybusIneqNameTime);
			                                            $("#zhkybusOnlyTimeSpan").text(res.detailMsg.data.zhkybusOnlyTime==null?"":res.detailMsg.data.zhkybusOnlyTime);
			                                            //$("#zhkybusRequiredTimeSpan").text(res.detailMsg.data.busRequiredTime==null?"":res.detailMsg.data.busRequiredTime);
													}
												} else {
													var msg = "";

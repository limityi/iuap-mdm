define(['text!pages/lisence/lisence.html', 'pages/lisence/meta','css!pages/lisence/lisence.css', 'uuitree', 'uuigrid' ],function(html) {
			var init = function(element) {
				...
				var viewModel = {
					...
					lisenceCompareSyncTime : '',
					lisenceOnlySynTime : '',
					lisenceRequiredSyncTime : '',
											...
											if (res) {
												if (res.success == 'success') {
													if (res.detailMsg.data) {
			                                            ...
			                                            viewModel.dtonly.setSimpleData(res.detailMsg.data.lisenceOnlyData.content,{unSelect:true});

			                                            viewModel.totleCountRequired=res.detailMsg.data.lisenceRequiredData.totalElements;
														viewModel.totlePageRequired=res.detailMsg.data.lisenceRequiredData.totalPages;

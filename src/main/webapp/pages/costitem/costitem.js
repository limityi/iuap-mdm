define(['text!pages/costitem/costitem.html', 'pages/costitem/meta', 'css!pages/costitem/costitem.css', 'uuitree', 'uuigrid'], function (html) {
    var init = function (element) {
        var listUrl = ctx + '/costitem/list?admin=admin';
        var delUrl = ctx + '/costitem/del/';
        var saveUrl = ctx + '/costitem/save';
        var exportExcelUrl = ctx + '/costitem/exportExcel';
        var removeDataUrl = ctx + '/costitem/removeData';

define(['text!pages/ticketsales/ticketsales.html', 'pages/ticketsales/meta', 'css!pages/ticketsales/ticketsales.css', 'uuitree', 'uuigrid'], function (html) {
    var init = function (element) {
        var listUrl = ctx + '/ticketsales/list?admin=admin';
        var delUrl = ctx + '/ticketsales/del/';
        var saveUrl = ctx + '/ticketsales/save';
        var exportExcelUrl = ctx + '/ticketsales/exportExcel';
        var removeDataUrl = ctx + '/ticketsales/removeData';
